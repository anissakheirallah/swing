...
public class Login extends JFrame{
    ...
    private void GUI() {
        ...
        textField_username = new JTextField("Anissa");
        ...
        passwordField_password = new JPasswordField("Anissa");
        ...
        button_login.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if(textField_username.getText().equals("Anissa") || String.valueOf(passwordField_password.getPassword()).equals("AYA")) {
